...
<div class="container mt-4">
    <div class="row justify-content-center">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
            ...
            $sql = "UPDATE user SET studentId='$studentId', firstName='$firstName', middleName='$middleName', lastName='$lastName', dateOfBirth='$dateOfBirth', email='$email', phoneNumber='$phoneNumber' WHERE id=$id";
